		...
		<div class="container">
			<div class="createTermContainer">
				<div class="createContent">
					...
					<form action="termCreate" method="post">
						<input class="textarea" type="text" name="termName" placeholder="*名称" id="termname" value="<%= request.getAttribute("termName") != null ? request.getAttribute("termName") : "" %>" required oninput="preventInvalidInput(this)">
