		...
		<div class="container">
			<div class="createTermContainer">
				<div class="createContent">
					...
					<form action="termUpdate" method="post">
						...
						<input class="textarea" type="text" name="reading" placeholder="*よみかた" value="<%=term.getReading()%>" id="termname" required oninput="preventInvalidInput(this)">
						
						<ul class="create-flex-list">
							<li><input class="textarea" type="text" name="abbreviation" placeholder="略称" value="<%=term.getAbbreviation()%>" id="ryaku" oninput="preventInvalidInput(this)"></li>
						...
						<textarea class="textarea" type="text" name="definition" placeholder="*説明" id="ex" required><%=term.getDefinition()%></textarea>
						<input class="btn2" type="submit" value="編集">
					</form>
				</div>
			</div>
		</div>
